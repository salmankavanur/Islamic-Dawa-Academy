  ...
  return (
    <div className="relative min-h-[90vh] bg-gradient-to-r from-[#1A4D2E] to-[#4A7C59] flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-20 relative z-10 flex flex-col md:flex-row items-center">
        ...
        >
          <motion.h1 
            className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight font-[var(--font-rubik)]"
          ...
          <motion.p 
            className="text-xl text-[#F5F5F5] mb-8 leading-relaxed font-[var(--font-dm-sans)]"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="relative w-full max-w-md aspect-square">
            ...
            <div className="absolute inset-8 rounded-full bg-white opacity-5 flex items-center justify-center">
              <div className="font-[var(--font-amiri)] text-6xl text-white opacity-80">
                اقرأ
              </div>
            </div>
          </div>
